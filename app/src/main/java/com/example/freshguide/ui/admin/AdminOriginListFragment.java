...
public class AdminOriginListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.tv_admin_page_title)).setText("Origins");
        ((TextView) view.findViewById(R.id.tv_admin_page_subtitle))
                .setText("Manage route starting points using the same wayfinding structure students use.");
        ...
        // No origin creation form — hide FAB
        ...
        adapter.setOnActionListener(new GenericListAdapter.OnActionListener() {
            ...
            public void onEdit(int position, int id) {
                // No origin form — edit not implemented
            }
        ...
        viewModel.getOrigins().observe(getViewLifecycleOwner(), originList -> {
            if (originList == null) return;
            List<GenericListAdapter.Item> items = new ArrayList<>();
            for (OriginDto o : originList) {
                items.add(new GenericListAdapter.Item(o.id, o.name, o.code != null ? o.code : ""));
            }
